...
[My Office]
My Office is a room. "A small cubicle, with just enough space to fit a desk and a relatively comfortable chair." The desk is scenery in My Office. The description of the desk is "The desk is a rich, dark brown mahogany with a couple drawers. It is cluttered with a sort of well-organized chaos of files, papers, letters, and god-knows-what-else. There is also your laptop." The drawer is part of the desk. The drawer is fixed in place. It is a closed, openable container. The description of the drawer is "Just an ordinary drawer, but I wonder what's inside." Understand "drawers" as the drawer. The chair is scenery in My Office. The description of the chair is "It looks pretty comfortable, but you have more important things to do than to just sit." The laptop is a thing. It is undescribed. It is on top of the desk. The description of the laptop is "You check the WiFi bars at the top right. Sadly, there is no WiFi connection where you are right now. I wonder why the WiFi is down...". Understand "computer" as the laptop.
...
[Electric Room]
The Electric Room is a dark room. The Electric Room is west of My Office. The description of the Electric Room is "As you enter the room and turn on the flashlight, you can see various things around the room." 
